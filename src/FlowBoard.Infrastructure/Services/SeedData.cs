...
public static class SeedData
{
    public static async Task EnsureSeededAsync(IServiceProvider sp)
    {
        ...
        // Board 2
        var b2 = Board.Create("Personal Board", clock).Value!;
        var colA = b2.AddColumn("Ideas").Value!;
        var colB = b2.AddColumn("In Progress").Value!;
        var colC = b2.AddColumn("Done").Value!;
