...
public sealed class RenameCardHandler(IBoardRepository repository) : IRequestHandler<RenameCardCommand, Result>
{
    ...
    public Task<Result> Handle(RenameCardCommand request, CancellationToken cancellationToken)
